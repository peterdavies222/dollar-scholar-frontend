        ...
        <aside className="nav">
            <nav>
                <div className="nav__upper">
                    <Link className="brandmark" to="/learn"><img src={brandmark} alt="Dollar Scholar" /></Link>
                    <ul>
                        <li>
                            <Link className={`nav__link ${section==="learn" ? "active" : ""}`} to="/learn">
                                <img src={learnIcon} alt="Lightbulb icon" />
                                <p>Learn</p>
                            </Link>
                        </li>
                        <li>
                            <Link className={`nav__link ${section==="revise" ? "active" : ""}`} to="/revise">
                                <img src={reviseIcon} alt="Book icon" />
                                <p>Revise</p>
                            </Link>
                        </li>
                        <li>
                            <Link className={`nav__link ${section==="leaderboard" ? "active" : ""}`} to="/leaderboard">
                ...
                <Link className={`nav__link profile ${section==="profile" ? "active" : ""}`} to="/profile">
